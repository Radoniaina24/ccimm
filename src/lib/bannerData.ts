...
export const BANNER_SLIDES: BannerSlide[] = [
  ...
  },
  {
    ...
    description:
      'L’innovation transforme les économies. La CCIMM encourage la digitalisation, les technologies émergentes et l’intelligence artificielle comme moteurs de compétitivité régionale.',
    ctaText: 'Devenir membre',
    ctaLink: '/membership',
    ctaSecondaryText: 'Avantages membres',
    ctaSecondaryLink: '/membership#benefits',
    alignment: 'center',
    overlayOpacity: 0.65,
  },
  {
